...
<body>
    ...
    <div class="container-fluid">
        <header class="row shadow-sm align-items-center header">
            ...
            <div
                class=" order-md-0 order-3 col-md col-sm-12 header__logo justify-content-md-center justify-content-center d-flex">
                ...
                <?php }else{ ?>
                    <a href="<?php echo Get_home_url(); ?>"><img src="<?php echo $path."/img/logo.png"?>" alt=""></a>
                <?php
                }
                ?>
            </div>
            ...
            <div
                class=" order-md-3 order-0 col-sm-12 col-md-6  d-flex header__contact-information align-items-center justify-content-around flex-md-row">
                ...
                <div
                    class="col header__contact-information__call-button justify-content-end d-flex d-sm-flex d-md-block">
        ...
        <nav class="menu-gamburger d-flex flex-column d-sm-flex d-md-none  justify-content-center">
            ...
            <label class="menu-gamburger__label" for="menu">Menu</label>
        ...
        <div class="callback-popup  flex-column col-9 col-sm-7 col-md-5 col-lg-3" id="popup1">
            ...
            <div class="callback-popup__form d-flex">
                <form class="d-flex flex-column  col" action="wp-admin/admin-ajax.php" method="POST">
                    ...
                    <input class="btn btn-danger" onclick="good_data();"  type="submit" id="callback_btn_send" value="Отправить">
                </form>
            </div>
        </div>
        <!-- end callback-PopUp -->
