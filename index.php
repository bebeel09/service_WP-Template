...
<section class="page-layout  flex-wrap">
    <div class="container p-0">
        ...
        <div class="row justify-content-around p-3">
            <div class="page-layout__repair-block p-4">
                ...
                <form class="page-layout__repair-block__form  d-flex flex-column  " action="/status/" method="POST">
                    ...
                    <input class="page-layout__repair-block__form__submit btn"
                        onclick="yaCounter50460370.reachGoal('status_remonta');" type="submit" value="Подтвердить">
                </form>
            </div>
            <!-- <div
...
<section class=" content">
    <div class="container content__description">
        <div class="content__description__title">
            <h2>Ремонт сварочного оборудования</h2>
        </div>
...
<section class="container p-0 dignites">
    <div class="d-flex justify-content-center dignites__video ">
        <iframe width="800" height="450" src="https://www.youtube.com/embed/T1zgVuFq6OU" frameborder="0"
            allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>

    <div class=" dignites__main d-flex flex-column align-items-center">
        <div class="icon dignites__main__img ml-3">
        </div>

        <div class="col-12 justify-content-center dignites__main__title align-items-center">
            <div>Ремонт и сервисное обслуживание</div>
        </div>

        <div class="col-12 justify-content-center dignites__main__desc">
    ...
    <div class="dignites__item d-flex justify-content-center">
        <div
            class="col-12 col-md-8 flex-column d-flex flex-md-row align-items-center  dignites__item__1">
    ...
    <div class="dignites__item d-flex justify-content-center">
        <div
            class="col-12 col-md-8 flex-column d-flex flex-md-row align-items-center  dignites__item__2">
    ...
    <div class="dignites__item d-flex justify-content-center">
        <div
            class="col-12 col-md-8 flex-column d-flex flex-md-row align-items-center  dignites__item__3">
    ...
    <div class="dignites__item d-flex justify-content-center">
        <div
            class="col-12 col-md-8 flex-column d-flex flex-md-row align-items-center  dignites__item__4">
